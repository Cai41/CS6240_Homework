...
/**
 * Parse each html file, extract all outlinks using provided WikiParser class.
 * @author caiyang
 *
 */
public class PreProcessMapper extends Mapper<Object, Text, Text, NodeWritable> {
	...
	public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
		try {
			...
			id.set(pageName);
			nw.setAdj(linkPageNames);
			context.write(id, nw);
			nw.setAdj(new ArrayList<>());
